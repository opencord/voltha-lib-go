...
func StartTracing(traceAgentAddress string) (io.Closer, error) {
	...
	if err != nil {
		...
		// Thus, use localhost IP for Reporter initialization before throwing back any error
	...
	jSamplerConfig := jcfg.SamplerConfig{Type: "const", Param: 1}
