...
const (
	...
	*/
	...
	//format: <device_id>/onu_packetin/<intfid>,<onuid>,<logicalport>
...
func (PONRMgr *PONResourceManager) UpdateGemPortForPktIn(intfID uint32, onuID uint32, portNum uint32, gemPort interface{}) error {
	/*
           update gem port for pkt in to the kvstore
          :param intfid: refremce pon intfid
          :param onuid: refrence onu id.
          :param portnum: refrence uni portno.
          :param gemport: refrence gemport to be stored on to kvstore.
        */

	path := fmt.Sprintf(ONU_PACKETIN_PATH, PONRMgr.DeviceID, intfID, onuID, portNum)
...
func (PONRMgr *PONResourceManager) GetGemPortFromOnuPktIn(intfID uint32, onuID uint32, portNum uint32, gemPort interface{}) error {
	...
	/*
          ...
          :param onuid: refrence onu id.
          :param portnum: refrence uni portno.
          :param gemport: gemport to be returned from kvstore.
        */
...
func (PONRMgr *PONResourceManager) DelGemPortPktIn(intfID uint32, onuID uint32, logicalPort uint32) error {
	...
	/*
          delete gem port for pkt in to the kvstore
          :param intfid: refremce pon intfid
          :param onuid: refrence onu id.
          :param portnum: refrence uni portno.
          :param gemport: gemport to be deleted from kvstore.
        */
