...
func NewRequestHandlerProxy(ctx context.Context, coreInstanceId string, iadapter adapters.IAdapter, cProxy adapterif.CoreProxy) *RequestHandlerProxy {
...
func (rhp *RequestHandlerProxy) Adapter_descriptor(ctx context.Context) (*empty.Empty, error) {
	return new(empty.Empty), nil
}

func (rhp *RequestHandlerProxy) Device_types(ctx context.Context) (*voltha.DeviceTypes, error) {
	return nil, nil
}

func (rhp *RequestHandlerProxy) Health(ctx context.Context) (*voltha.HealthStatus, error) {
	return nil, nil
}
...
func (rhp *RequestHandlerProxy) Adopt_device(ctx context.Context, args []*ic.Argument) (*empty.Empty, error) {
	...
	rhp.coreProxy.UpdateCoreReference(ctx, device.Id, fromTopic.Val)
...
func (rhp *RequestHandlerProxy) Abandon_device(ctx context.Context, args []*ic.Argument) (*empty.Empty, error) {
	return new(empty.Empty), nil
}
...
func (rhp *RequestHandlerProxy) Self_test_device(ctx context.Context, args []*ic.Argument) (*empty.Empty, error) {
	return new(empty.Empty), nil
}
...
func (rhp *RequestHandlerProxy) Get_device_details(ctx context.Context, args []*ic.Argument) (*empty.Empty, error) {
	return new(empty.Empty), nil
}
...
func (rhp *RequestHandlerProxy) Suppress_alarm(ctx context.Context, args []*ic.Argument) (*empty.Empty, error) {
	return new(empty.Empty), nil
}

func (rhp *RequestHandlerProxy) Unsuppress_alarm(ctx context.Context, args []*ic.Argument) (*empty.Empty, error) {
	return new(empty.Empty), nil
}
...
func (rhp *RequestHandlerProxy) Get_ofp_port_info(ctx context.Context, args []*ic.Argument) (*ic.PortCapability, error) {
	if len(args) < 3 {
		logger.Warn("invalid-number-of-args", log.Fields{"args": args})
		err := errors.New("invalid-number-of-args")
		return nil, err
	...
	var err error
	if cap, err = rhp.adapter.Get_ofp_port_info(ctx, device, pNo.Val); err != nil {
		return nil, status.Errorf(codes.NotFound, "%s", err.Error())
	}
	return cap, nil
}
...
func (rhp *RequestHandlerProxy) Child_device_lost(ctx context.Context, args []*ic.Argument) error {
	...
	//Update the core reference for that device
	rhp.coreProxy.UpdateCoreReference(ctx, pDeviceId.Val, fromTopic.Val)
