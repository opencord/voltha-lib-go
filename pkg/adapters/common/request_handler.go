...
func (rhp *RequestHandlerProxy) Download_image_to_device(ctx context.Context, args []*ic.Argument) (*voltha.DeviceImageResponse, error) {
	imageDownloadReq, err := rhp.getDeviceDownloadImageRequest(ctx, args)
	if err != nil {
		return nil, err
	}

	imageDownloadRsp, err := rhp.adapter.Download_image_to_device(ctx, imageDownloadReq)
	if err != nil {
		return nil, status.Errorf(codes.NotFound, "%s", err.Error())
	}
...
func (rhp *RequestHandlerProxy) Get_image_status(ctx context.Context, args []*ic.Argument) (*voltha.DeviceImageResponse, error) {
	imageStatusReq, err := rhp.getDeviceImageRequest(ctx, args)
	if err != nil {
		return nil, err
	}

	imageStatus, err := rhp.adapter.Get_image_status(ctx, imageStatusReq)
	if err != nil {
		return nil, status.Errorf(codes.NotFound, "%s", err.Error())
	}
...
func (rhp *RequestHandlerProxy) Abort_image_upgrade_to_device(ctx context.Context, args []*ic.Argument) (*voltha.DeviceImageResponse, error) {
	imageAbortReq, err := rhp.getDeviceImageRequest(ctx, args)
	if err != nil {
		return nil, err
	}

	imageAbortRsp, err := rhp.adapter.Abort_image_upgrade_to_device(ctx, imageAbortReq)
	if err != nil {
		return nil, status.Errorf(codes.NotFound, "%s", err.Error())
	}
...
func (rhp *RequestHandlerProxy) Activate_image(ctx context.Context, args []*ic.Argument) (*voltha.DeviceImageResponse, error) {
	imageActivateReq, err := rhp.getDeviceImageRequest(ctx, args)
	if err != nil {
		return nil, err
	}

	imageActivateRsp, err := rhp.adapter.Activate_image(ctx, imageActivateReq)
	if err != nil {
		return nil, status.Errorf(codes.NotFound, "%s", err.Error())
	}
...
func (rhp *RequestHandlerProxy) Commit_image(ctx context.Context, args []*ic.Argument) (*voltha.DeviceImageResponse, error) {
	imageCommitReq, err := rhp.getDeviceImageRequest(ctx, args)
	if err != nil {
		return nil, err
	}

	imageCommitRsp, err := rhp.adapter.Commit_image(ctx, imageCommitReq)
	if err != nil {
		return nil, status.Errorf(codes.NotFound, "%s", err.Error())
	}
