...
//PrepareDeviceStateChangeEvent forms and returns a new DeviceStateChange Event
func PrepareDeviceStateChangeEvent(serialNumber string, deviceID string, parentID string,
	...
	de.DeviceEventName = fmt.Sprintf("%s_%s", string(DeviceStateChangeEvent), string(Raise))
