...
//PrepareDeviceStateChangeEvent forms and returns new DeviceStateChange Event
func PrepareDeviceStateChangeEvent(ctx context.Context, serialNumber string, deviceID string, parentID string,
