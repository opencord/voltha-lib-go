...
func (sc *SaramaClient) isLivenessError(err error) bool {
	...
	if strings.Contains(err.Error(), "connection refused") { // "dial tcp 10.244.1.176:9092: connect: connection refused"
	...
	log.Infow("smbaker is-liveness-error-ignored", log.Fields{"err": err})
